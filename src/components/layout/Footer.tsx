      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          <div className="flex flex-col gap-4">
            <span className="font-heading text-xl italic">Explore NPM</span>
            <p className="max-w-xs text-sm text-muted-foreground">
              Discover trending and newly surfaced npm packages, organized by category.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <p className="text-xs text-muted-foreground">© 2026 Explore NPM. All rights reserved.</p>
